...
class TestOrderForm(TestCase):
    ...
    # def test_items_not_required(self):
    #     form = OrderForm({'full_name': 'bobby'},{'email': 'bobby@bob.com'},{'phone_number': '0874166750'},{'street_address1': 'bobbystreet'},{'town_or_city': 'bobbytown'},{'country': 'Ireland'})
    #     self.assertFalse(form.is_valid())
